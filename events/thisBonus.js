...
module.exports = {
    thisBonus: async function (gtaRDO) {
			...
			if (gtaRDO === 'gta') {
				...
				var date = new Date();
				var thisBonus1 = getgtaParse.data.posts.results[1].created_formatted; //fixme - implement latestBonus()
				...
				var date = new Date();
				var thisRDOBonus1 = getrdoParse.data.posts.results[0].created_formatted; //fixme- implement latestBonus()
