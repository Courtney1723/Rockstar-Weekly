...
module.exports = {
  ...
  let args = rdo1.split("\"header\\\"\\u003e") // gets latest post
    ...
    let rdoLaterBody = args[6].split("u003cb\\u003e")  
        ...
        let rdoLaterBody2 = rdoLaterBody1[1].split("\\u003c\/li\\u003e\\u003c\/ul\\u003e\"") // gets the "other" update body post
  ...
  if (message.content.toLowerCase().startsWith(prefix + "rdo")) {
    ...
    message.channel.send({embed: {
            ...
            description: `**Last Updated ${rdoDate[0]}**\n\n${rdoBody1[1]}\n\n**Monthly Bonuses:**\n${rdoMonthBody1[1]} \n\n **Other Bonuses:**\n ${rdoLaterBodyDate1[0]}\n\n${rdoLaterBody2[0]}\n\n[Click Here](https://www.ign.com/wikis/red-dead-redemption-2/Red_Dead_Online_Updates_Archive) to view more bonuses & discounts`
            .replace(/\\u0026#x2019;/g , "'")
            .replace(/\\u003c\/b\\u003e\\u003cbr\\u003e/g, "\n")
            .replace(/\\u003cbr\\u003e/g, "\n")
            .replace(/\\u003c\/li\\u003e\\n\\u003cli\\u003e \\u003cb\\u003e/g, "\n\n")
